...
| **Two knobs below the finger pads** (MIDI Pro 3) | **CC 71 (upper), CC 74 (lower)** at factory settings | Global channel (default 1) | Absolute 0–127. *Not documented in the Jan 2023 guide (pre-MP3); values measured from real hardware via TrackMagnet debug mode, 2026-07.* Each message was observed to arrive twice (guitar or WIDI double-send) — harmless for absolute values. |
